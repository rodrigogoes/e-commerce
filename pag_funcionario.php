...
<h1 style="margin-top: 25px" class="container">Página do Funcionário</h1>

<ul class="container" style="margin-top: 25px; margin-bottom: 150px">


                    <a type="button" class="btn btn-success" style="text-decoration: none; color: #fff" href="cad_funcionario.php">Cadastro de Funcionário</a>
