        ...
        <div id="register" class="animate form">
            <form  action="update_produto.php" method="POST"> 
                ...
                <p> 
                    ...
                    <input id="usernamesignup" name="id" required="required" type="text" placeholder="Digite o ID correspondente ao produto" />
                </p>
                <p> 
                    <label for="usernamesignup" class="uname" data-icon="u">Nome do Produto</label></br>
                    <input id="usernamesignup" name="nome" type="text" placeholder="Ex.: PlayStation 4" />
                </p>
                <p> 
                    <label for="descricao" class="usame" data-icon="e" >Descrição do Produto</label></br>
                    <input id="descricao" name="descricao" type="text" placeholder="Insira a descrição do produto"/> 
                </p>
                <p> 
                    <label for="preco" class="usame" data-icon="e" >Preço do Produto</label></br>
                    <input id="preco" name="preco" type="text" placeholder=""/> 
                </p>
                <p> 
                ...
                <p> 
                    ...
                    <input name="foto" type="text" placeholder="Digite o endereço da imagem"/>
                </p>
                <button style="width: 96%" type="submit" class="btn btn-success btn-lg btn-block">Alterar Produto</button>
            </form>
        </div>
